...
本文件对仓库中的设计、文档、代码、测试、配置、候选变更、Git、发布、部署及权威外部状态操作强制生效，只规定语义权威、任务分类与权限、候选隔离和完成证据。
...
- 不为业务约束已排除的情况增加防御性检查或兜底。例如，业务已保证对象非空时，不再增加判空分支。
